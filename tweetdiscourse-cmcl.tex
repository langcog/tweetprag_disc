...
[Note: final values of effect sizes and p-values, based on full regression model, will be added tonight.]
...
\begin{figure}
 ...
 \caption{Per-word (top) and per-tweet (bottom) entropy are lower for tweets with smaller expected audience size. Linear fits with 95\% confidence intervals.}\label{fig:audience}\vspace*{-.5em}
\end{figure}
